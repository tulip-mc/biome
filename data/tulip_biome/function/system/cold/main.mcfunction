...
execute if biome ~ ~ ~ #tulip_biome:cold_extreme if score @s temp_store.tulip_biome.player.cold_time >= cold.cold_player_interval_extreme tulip.config unless score @s tulip_biome.player.cold matches ..0 run function tulip_biome:system/cold/decrease
